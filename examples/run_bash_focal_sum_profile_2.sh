...
# python -m cProfile -o profile_inner_itr_[200]_global_[100]_focal_sum.dat ../../source/script/run_test_focal_sum.py --hpx:threads=$nr_threads param_h_10_10_NOT_permafrost_vegetation.txt
python -m cProfile -o profile_inner_itr_[200]_global_[1000]_focal_sum.dat ../source/script/run_test_focal_sum.py --hpx:threads=$nr_threads 10 10 1000 200 0.5
