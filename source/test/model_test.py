...
class TestPackage(unittest.TestCase):
    ...
    def test_version_attribute(self):
        self.assertTrue(hasattr(soli3d, "__version__"))
        self.assertTrue(isinstance(soli3d.__version__, str))
        print("version ", soli3d.__version__)
    ...
    def test_second_derivatives_in_y(self) -> None:
        ...
        layer_variable_ref = lfr.from_gdal(
            "source/test/h_test.tif", partition_shape=partition_shape
        )
